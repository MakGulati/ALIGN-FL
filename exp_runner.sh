...
commands=(
    ...
    "python -m ALIGN_FL.runner.sim_fed_align_vae -i fedalign_out_percent5_no_dp_lip0.1 -c 5 -dp no_dp -dim 2 -r 5 -lip 0.1 -dt fmnist"
    "python -m ALIGN_FL.runner.sim_fed_align_vae -i fedalign_out_percent5_full_dp_lip0 -c 5 -dp full_dp -dim 2 -r 5 -lip 0 -dt fmnist"
